...
print(df[df["Python"]>=70])
print(df.loc[1])
print(df.iloc[1])

df["Total"] = df["Python"] + df["NumPy"] + df["Pandas"]
df["Average"] = df["Total"] / 3
df["Result"]= np.where(df["Average"]>=50, "Pass","Fail")
df=df.sort_values("Average",  ascending=False)
print(df) 
print("==========")
df = pd.read_csv(r"C:\Users\Office\ml_project\students.csv")
print(df)
...
print("==========")
print(df.columns)
>>>>>>> e97dac7 (Update Student Performance Project)
